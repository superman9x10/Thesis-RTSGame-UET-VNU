...
public class ResourceManager : MonoBehaviour {
    ...
    private void Awake() {
        ...
        AddResourceAmount(ResourceTypeSO.ResourceType.Iron, 5000);
        AddResourceAmount(ResourceTypeSO.ResourceType.Gold, 5000);
        AddResourceAmount(ResourceTypeSO.ResourceType.Oil, 5000);
    }
